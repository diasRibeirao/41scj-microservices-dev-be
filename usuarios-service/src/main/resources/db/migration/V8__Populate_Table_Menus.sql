 INSERT INTO `menus` (`nome`,`descricao`,`icone`, `rota`,  `ordem` ) VALUES 
        ('Plano', 'Plano cadastrado', 'bi bi-sliders', '/definir', 1),
  	('Veículos', 'Configurações do veículo', 'bi bi-gear', '/definir', 2),
